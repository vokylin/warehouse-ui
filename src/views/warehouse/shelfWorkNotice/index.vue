    ...
    <el-row :gutter="10" class="mb8">
      <!--<el-col :span="1.5">
        <el-button
          ...
          size="mini"
          :disabled="multiple && isWholeWork"
          @click="handleAllWork"
          v-hasPermi="['warehouse:shelfWorkNotice:handleAllWork']"
          >整单作业</el-button
        >
      </el-col>-->
      <right-toolbar
      ...
      <el-table-column label="操作" align="center" fixed="right" width="200">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['warehouse:shelfWorkNotice:manualWork']"
            >手动作业</el-button
          >
        </template>
      </el-table-column>
...
<script>
import { listWorkNotice, wholeWor } from "@/api/warehouse/workNotice";
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map((item) => {
        if (item.status !== "2") {
          this.isWholeWork = false;
        } else {
          this.isWholeWork = true;
        }
        return item.id;
      });
